...
matxi = SpinHamiltonianSuperoperatorOffDiag(ind_offdiag, B0, psi, In, g, A, ald,bed,gad, alm,bem,gam)
...
print(np.max(np.abs(a-matxi-3300 * iden)))
err = a-matxi-3300 * iden
err = err.tocoo()
print(err)
print(err.shape)
#np.savetxt('diffmat.txt',err)
