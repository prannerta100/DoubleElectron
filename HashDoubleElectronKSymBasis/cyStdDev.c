...
static PyObject *__pyx_pf_8cyStdDev_cStdDev(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_a); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_8cyStdDev_1cStdDev(PyObject *__pyx_self, PyObject *__pyx_v_a); /*proto*/
static PyMethodDef __pyx_mdef_8cyStdDev_1cStdDev = {"cStdDev", (PyCFunction)__pyx_pw_8cyStdDev_1cStdDev, METH_O, 0};
static PyObject *__pyx_pw_8cyStdDev_1cStdDev(PyObject *__pyx_self, PyObject *__pyx_v_a) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("cStdDev (wrapper)", 0);
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_a), __pyx_ptype_5numpy_ndarray, 0, "a", 0))) __PYX_ERR(0, 5, __pyx_L1_error)
  __pyx_r = __pyx_pf_8cyStdDev_cStdDev(__pyx_self, ((PyArrayObject *)__pyx_v_a));
...
static PyObject *__pyx_pf_8cyStdDev_cStdDev(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_a) {
  ...
  __pyx_pybuffernd_a.rcbuffer = &__pyx_pybuffer_a;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_a.rcbuffer->pybuffer, (PyObject*)__pyx_v_a, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 5, __pyx_L1_error)
  }
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_As_size_t(__pyx_t_1); if (unlikely((__pyx_t_2 == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyFloat_FromDouble(std_dev(((double *)__pyx_v_a->data), __pyx_t_2)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 *     return std_dev(<double*> a.data, a.size)
 */
  __pyx_tuple__8 = PyTuple_Pack(1, __pyx_n_s_a); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(1, 0, 1, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cyStdDev_pyx, __pyx_n_s_cStdDev, 5, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 *     return std_dev(<double*> a.data, a.size)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_8cyStdDev_1cStdDev, NULL, __pyx_n_s_cyStdDev); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_cStdDev, __pyx_t_1) < 0) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
