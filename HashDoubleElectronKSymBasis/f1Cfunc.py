...
Lstarts_offdiag, Lstarts_diag, Lstarts_Plus1, Lstarts_Plus2, Lstarts_Minus1, Llist, ind_diag_rev = \
...
stt = time.time()
matzi = SpinHamiltonianSuperoperatorDiag(ind_diag, B0, psi, In, g, A, ald,bed,gad, alm,bem,gam, Llist, Lstarts_diag, ind_diag_rev)
io.mmwrite('Hash_matz',matzi.tocoo())
...
io.mmwrite('matdip_Plus1',-1.0j*matdip.tocoo())
stp = time.time()
